...
const ALL_ALUMNI: DavidsonAlumni[] = [
  ...
  },
  {
    ...
    location: "Atlanta, GA",
    linkedinSearch: buildLinkedInSearch("Max Shackelford", "Bain"),
    bio: "Active in Davidson Catholic Campus Ministry and pre-business organizations. Recruited through Bain's dedicated Davidson pipeline.",
    careerFields: ["management-consulting"],
  },
  {
    name: "Cate Rhoades",
    ...
    company: "Bain & Company",
    location: "Boston, MA",
    linkedinSearch: buildLinkedInSearch("Cate Rhoades", "Bain"),
    bio: "Economics major who leveraged Davidson's strong Bain recruiting pipeline. Active in campus leadership and pre-professional organizations.",
    careerFields: ["management-consulting"],
  },
  {
    name: "Steve Shames",
